  ...
  return (
    <main>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-input date-time">
          <div className="form-input">
        ...
        <div className="form-input guests-occasion">
          <div className="form-input">
        ...
        <input className="reserve-button" type="submit" value="Reserve" aria-label="submit button" />
      </form>
    </main>
  );
}
